...
export const DEFAULT_MATERIALS: MaterialRate[] = [
  // —— Cement & Concrete ——
  m({ id: 'cement', name: 'Ordinary Portland Cement (50 kg)', description: 'OPC 53 Grade — standard bag', category: 'cement', unit: 'bag', defaultRate: 1400, rate: 1400, consumptionNote: 'ENGINE: concrete, masonry, plaster, roofing' }),
  ...
  m({ id: 'sand', name: 'Fine Sand (Chenab / Ravi)', description: 'Clean fine aggregate for mortar & concrete', category: 'sand', unit: 'm3', defaultRate: 5300, rate: 5300, consumptionNote: 'ENGINE: concrete, masonry, plaster' }),
  m({ id: 'sand-cft', name: 'Fine Sand', description: 'Same sand priced per cubic foot', category: 'sand', unit: 'cft', defaultRate: 150, rate: 150 }),
  m({ id: 'crush', name: 'Crush / Coarse Aggregate ¾"', description: 'Crushed stone for RCC', category: 'crush', unit: 'm3', defaultRate: 4200, rate: 4200, consumptionNote: 'ENGINE: concrete' }),
  m({ id: 'crush-cft', name: 'Crush / Aggregate ¾"', description: 'Priced per cft', category: 'crush', unit: 'cft', defaultRate: 120, rate: 120 }),
  ...
  // —— Reinforcement ——
  m({ id: 'steel-deformed', name: 'Deformed Steel Bars Grade 60', description: 'Tor steel Grade 60 (ENGINE)', category: 'steel', unit: 'kg', defaultRate: 245, rate: 245, consumptionNote: 'ENGINE: RCC & BBS' }),
  ...
  // —— Masonry ——
  m({ id: 'bricks', name: 'First Class Burnt Clay Bricks', description: 'Standard modular bricks incl. rorhi (ENGINE)', category: 'bricks', unit: 'nos', defaultRate: 26, rate: 26, consumptionNote: 'ENGINE: masonry' }),
  ...
  // —— Flooring ——
  m({ id: 'floor-tiles', name: 'Porcelain Floor Tiles 600×600', description: 'Premium porcelain (ENGINE)', category: 'tiles', unit: 'm2', defaultRate: 3275, rate: 3275, consumptionNote: 'ENGINE: floor tiles' }),
  m({ id: 'wall-tiles', name: 'Ceramic Wall Tiles 300×600', description: 'Glazed ceramic (ENGINE)', category: 'tiles', unit: 'm2', defaultRate: 3050, rate: 3050, consumptionNote: 'ENGINE: wall tiles' }),
  ...
  // —— Paint ——
  m({ id: 'paint', name: 'Plastic Emulsion Paint', description: 'Interior/exterior emulsion (ENGINE)', category: 'paint', unit: 'ltr', defaultRate: 1100, rate: 1100, consumptionNote: 'ENGINE: paint' }),
  ...
  // —— Doors ——
  m({ id: 'door-shutter', name: 'Solid Core Flush Door', description: 'Commercial flush door (ENGINE)', category: 'wood', unit: 'm2', defaultRate: 6500, rate: 6500, consumptionNote: 'ENGINE: doors' }),
  ...
  // —— Windows ——
  m({ id: 'aluminium-window', name: 'Aluminium Window with Glass', description: 'Sliding/casement (ENGINE)', category: 'hardware', unit: 'm2', defaultRate: 7500, rate: 7500, consumptionNote: 'ENGINE: windows' }),
  ...
  m({ id: 'pvc-conduit-25', name: 'PVC Conduit 25mm', description: 'Grey electrical conduit', category: 'electrical', unit: 'rm', defaultRate: 32, rate: 32 }),
  m({ id: 'pvc-conduit-32', name: 'PVC Conduit 32mm', description: 'Grey electrical conduit', category: 'electrical', unit: 'rm', defaultRate: 48, rate: 48 }),
  ...
  m({ id: 'db-box', name: 'Distribution Board Box', description: 'DB enclosure', category: 'electrical', unit: 'nos', defaultRate: 108370, rate: 108370 }),
  ...
  m({ id: 'copper-wire-1.5', name: 'Copper Wire 1.5mm²', description: 'PVC insulated (coil equiv.)', category: 'electrical', unit: 'rm', defaultRate: 42, rate: 42 }),
  m({ id: 'copper-wire-2.5', name: 'Copper Wire 2.5mm²', description: 'PVC insulated', category: 'electrical', unit: 'rm', defaultRate: 65, rate: 65 }),
  m({ id: 'copper-wire-4', name: 'Copper Wire 4mm²', description: 'PVC insulated', category: 'electrical', unit: 'rm', defaultRate: 105, rate: 105 }),
  m({ id: 'copper-wire-6', name: 'Copper Wire 6mm²', description: 'PVC insulated', category: 'electrical', unit: 'rm', defaultRate: 155, rate: 155 }),
  m({ id: 'copper-cable-16', name: 'Four Core 16mm² Cable', description: 'DB to energy meter', category: 'electrical', unit: 'rm', defaultRate: 1464, rate: 1464 }),
  ...
  m({ id: 'switch-1way', name: '1-Way Switch 10A', description: 'Piano / modular switch', category: 'electrical', unit: 'nos', defaultRate: 1260, rate: 1260 }),
  m({ id: 'socket-5a', name: '5A / 15A Socket', description: 'Power socket', category: 'electrical', unit: 'nos', defaultRate: 1458, rate: 1458 }),
  m({ id: 'led-light', name: 'LED Bulb / Panel 12–18W', description: 'Energy saving light', category: 'electrical', unit: 'nos', defaultRate: 1121, rate: 1121 }),
  m({ id: 'ceiling-light', name: 'Ceiling Light Fitting', description: 'Surface / recessed fitting', category: 'electrical', unit: 'nos', defaultRate: 2975, rate: 2975 }),
  m({ id: 'downlight', name: 'LED Downlight', description: 'Recessed downlight', category: 'electrical', unit: 'nos', defaultRate: 1200, rate: 1200 }),
  m({ id: 'ceiling-fan', name: 'Ceiling Fan 56"', description: 'AC ceiling fan', category: 'electrical', unit: 'nos', defaultRate: 9131, rate: 9131 }),
  m({ id: 'exhaust-fan', name: 'Exhaust Fan 8–12"', description: 'Washroom/kitchen exhaust', category: 'electrical', unit: 'nos', defaultRate: 5352, rate: 5352 }),
  ...
  // —— Plumbing ——
  m({ id: 'upvc-pipe-1', name: 'UPVC Pipe 1"', description: 'Water supply UPVC', category: 'plumbing', unit: 'rm', defaultRate: 105, rate: 105 }),
  m({ id: 'pprc-pipe-25', name: 'PPRC Pipe 25mm', description: 'Hot/cold water PPR', category: 'plumbing', unit: 'rm', defaultRate: 157, rate: 157 }),
  m({ id: 'pvc-pipe-4', name: 'PVC Soil Pipe 4"', description: 'Drainage PVC', category: 'plumbing', unit: 'rm', defaultRate: 172, rate: 172 }),
  m({ id: 'sewer-pipe-6', name: 'Sewer Pipe 6"', description: 'External sewer', category: 'plumbing', unit: 'rm', defaultRate: 345, rate: 345 }),
  ...
  m({ id: 'wash-basin', name: 'Wash Basin with Pedestal', description: 'Ceramic wash basin', category: 'plumbing', unit: 'set', defaultRate: 13309, rate: 13309 }),
  m({ id: 'wc-set', name: 'WC / Commode Set', description: 'English / Arabic WC', category: 'plumbing', unit: 'set', defaultRate: 21271, rate: 21271 }),
  m({ id: 'shower-set', name: 'Shower Set', description: 'Mixer shower set', category: 'plumbing', unit: 'set', defaultRate: 35451, rate: 35451 }),
  m({ id: 'mixer-tap', name: 'Basin / Sink Mixer', description: 'Single lever mixer', category: 'plumbing', unit: 'nos', defaultRate: 11986, rate: 11986 }),
  m({ id: 'kitchen-sink', name: 'Kitchen Sink Stainless', description: 'Single/double bowl sink', category: 'plumbing', unit: 'nos', defaultRate: 13235, rate: 13235 }),
  ...
  m({ id: 'water-pump', name: 'Water Booster Pump 0.75 HP', description: 'Domestic booster pump', category: 'plumbing', unit: 'nos', defaultRate: 137961, rate: 137961 }),
  m({ id: 'submersible-pump', name: 'Submersible Transfer Pump 1 HP', description: 'Water transfer pump', category: 'plumbing', unit: 'nos', defaultRate: 142641, rate: 142641 }),

  // —— Roofing / ceiling ——
  m({ id: 'gypsum-board', name: 'Gypsum Board Ceiling 12.5mm', description: 'Board with frame allowance (ENGINE)', category: 'other', unit: 'm2', defaultRate: 1475, rate: 1475, consumptionNote: 'ENGINE: ceiling' }),
  m({ id: 'geyser', name: 'Electric Geyser 25–50 L', description: 'Instant / storage geyser', category: 'plumbing', unit: 'nos', defaultRate: 31863, rate: 31863 }),
  m({ id: 'wardrobe-unit', name: 'Built-in Wardrobe', description: 'Bedroom wardrobe', category: 'wood', unit: 'nos', defaultRate: 76471, rate: 76471 }),
  m({ id: 'kitchen-cabinet', name: 'Kitchen Cabinets', description: 'Modular kitchen cabinets', category: 'wood', unit: 'nos', defaultRate: 105882, rate: 105882 }),
  m({ id: 'main-gate', name: 'Main Entrance Gate', description: 'MS / wrought iron main gate', category: 'miscellaneous', unit: 'nos', defaultRate: 130392, rate: 130392 }),
  m({ id: 'roof-insulation', name: 'Roof Thermal Insulation', description: 'XPS / foam insulation', category: 'roofing', unit: 'm2', defaultRate: 46, rate: 46 }),
  ...
  m({ id: 'railings', name: 'MS / SS Railings', description: 'Staircase / balcony railing', category: 'miscellaneous', unit: 'rm', defaultRate: 1574, rate: 1574 }),
];
...
export const DEFAULT_LABOUR: LabourRate[] = [
  ...
  l({ id: 'masonry-labour', name: 'Masonry Labour', description: 'Brick/block laying (ENGINE)', unit: 'm3', defaultRate: 2800, rate: 2800, category: 'masonry', rateBasis: 'unit' }),
  l({ id: 'plaster-labour', name: 'Plaster Labour', description: 'Cement plaster (ENGINE)', unit: 'm2', defaultRate: 95, rate: 95, category: 'finishing', rateBasis: 'unit' }),
  l({ id: 'paint-labour', name: 'Painter (unit)', description: 'Painting & finishing (ENGINE)', unit: 'm2', defaultRate: 56, rate: 56, category: 'finishing', rateBasis: 'unit' }),
  l({ id: 'tile-labour', name: 'Tile Fixer (unit)', description: 'Tile fixing (ENGINE)', unit: 'm2', defaultRate: 140, rate: 140, category: 'finishing', rateBasis: 'unit' }),
  ...
  l({ id: 'electrician-unit', name: 'Electrician (point rate)', description: 'Per electrical point', unit: 'nos', defaultRate: 650, rate: 650, category: 'electrical', rateBasis: 'unit' }),
  l({ id: 'plumber-unit', name: 'Plumber (point rate)', description: 'Per plumbing point', unit: 'nos', defaultRate: 750, rate: 750, category: 'plumbing', rateBasis: 'unit' }),
  l({ id: 'electrical-labour-lump', name: 'Electrical Labour Package', description: 'Complete electrical labour', unit: 'job', defaultRate: 80000, rate: 80000, category: 'electrical', rateBasis: 'unit' }),
  l({ id: 'plumbing-labour-lump', name: 'Plumbing Labour Package', description: 'Complete plumbing labour', unit: 'job', defaultRate: 77000, rate: 77000, category: 'plumbing', rateBasis: 'unit' }),
];
